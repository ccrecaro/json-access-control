...
import { INTEGER_SUBTRACT } from "../../../constants/Functions";
import { RequestCtx } from "../architecture/context/RequestCtx";
import { Expression } from "../expression/Expression";
import { EvaluationResult } from "../result/EvaluationResult";
import { BaseFunction } from "./BaseFunction";

export class SubFunction extends BaseFunction {
    ...
    public evaluateFunction(inputs: Expression[], request: RequestCtx): EvaluationResult|null {
        ...
        var difference: number = arg0 - arg1;


        const dataType = this.functionId == INTEGER_SUBTRACT ? INTEGER : DOUBLE;
        result = new EvaluationResult(false, difference, dataType, null, null);
        return result;
    }
